...
export function NAV(base = '', active = '') {
  return {
    ...
    links: [
      ...
      { id: 'ai-sales-funnel', label: 'AI Sales Funnel', href: `${base}ai-sales-funnel.html` },
      { id: 'campaigns', label: 'AI Campaigns', href: `${base}campaigns.html` },
      { id: 'portfolio', label: 'Portfolio', href: `${base}index.html#work` },
