...
interface ParallaxImageProps {
  src: string;
  alt: string;
  placeholder: "hero" | "bag" | "bean" | "pour" | "cup" | "product" | "origin" | "atmosphere";
  darkPlaceholder?: boolean;
  ratio?: string;
  className?: string;
  /** px of vertical drift across the viewport pass — kept subtle by design. */
  strength?: number;
}

/** A self-contained scroll-scrubbed parallax image: the visual drifts a
 *  little slower/faster than the page, independent of any pinned scene. */
